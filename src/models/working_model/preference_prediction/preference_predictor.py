...
class PreferencePredictor(mp.ModelParameter):
  ...
  VERSION = 'Traj_dS103_Query_dS103_pred'
...
#  DIR_PREDICTION_DATA_QUERY_STATE = DIR_PREDICTION_DATA_TRAJECTORY
  ...
  def parse_prediction_data_subset(self, directory, parse_query_state, subset_size, with_label = True):
    ...
    # TODO: instantiate human/simulated data handler
    """
    data_type = args.data_type
    self.data_manager = dm.DataManager()
    data_handler = self.data_manager.handle_data(data_type)
    """
...
if __name__ == "__main__":
    ...
    # TODO: implement the human/simulation arg into cli & pass into classes
    """
