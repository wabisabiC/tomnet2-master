...
PATH_ROOT = str_extract(string = getwd(),
                        pattern = "/bml/Data/Bank1/ToMNET/tomnet-project/tomnet2/tomnet2")
...
if(interactive()){
  ...
  cat(paste0("/bml/Data/Bank1/ToMNET/tomnet-project/tomnet2/tomnet2/models/working_model/test_on_simulation_data \n"))
